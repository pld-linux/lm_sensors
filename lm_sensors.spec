...
prЙdko╤Ф wiatrakСw odpowiednio.

Kluczowym jest, aby poprawnie skonfigurowaФ tego demona (poprzez
uruchomienie service fancontrol init) oraz upewniФ siЙ, ©e progi temperatury
s╠ ustawione poprawnie, by nie spaliФ wnЙtrza komputera!
